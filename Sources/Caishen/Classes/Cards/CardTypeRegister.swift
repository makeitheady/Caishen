...
open class CardTypeRegister {
     ...
     */
    nonisolated(unsafe) public static let sharedCardTypeRegister = CardTypeRegister(registeredCardTypes: CardTypeRegister.defaultCardTypes)
    ...
    nonisolated(unsafe) public static let defaultCardTypes: [CardType] = [
            AmericanExpress(),
            ChinaUnionPay(),
            DinersClub(),
            Discover(),
