...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :git => "https://github.com/makeitheady/Caishen.git", :branch => "chore/enable-spm" }

  s.platform     = :ios, '12.0'
  s.requires_arc = true
  s.swift_version = '4.2'

  s.source_files = 'Sources/Caishen/**/*{.swift}'
  s.resources = ['Sources/Caishen/Resources/*']
end
