...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :git => "https://github.com/makeitheady/caishen.git", :branch => "chore/spm-migration" }

  s.platform     = :ios, '12.0'
  s.requires_arc = true
  s.swift_version = '5.0'

  s.source_files = 'Caishen/Sources/Caishen/Classes/**/*'
  s.resources = ['Caishen/Sources/Assets/*']
end
